    ...
    useEffect(()=>{
        let camera: any, stats: any, model: any;
			...
			async function init() {
				...
				const gltf = await loader.loadAsync( '/MUP.glb' );//'models/gltf/PrimaryIonDrive.glb''https://spamigor.ru/library/threejs/examples/models/gltf/Parrot.glb'

				model = gltf.scene;
                //model.position.x = -360;
			...
			function animate() {
				...
				//let value = (Math.sin(Number(new Date())/1000)+1)*1;
